...
[ExecuteInEditMode]
public class Kooima : MonoBehaviour
{
    ...
    void LateUpdate ()
    {
        Vector3 pa = projectionScreen.transform.TransformPoint(
            new Vector3(-screenSize * 0.5f, 0.0f, -screenSize * 0.5f));
        // lower left corner in world coordinates
        Vector3 pb = projectionScreen.transform.TransformPoint(
            new Vector3(screenSize * 0.5f, 0.0f, -screenSize * 0.5f));
        // lower right corner
        Vector3 pc = projectionScreen.transform.TransformPoint(
            new Vector3(-screenSize * 0.5f, 0.0f, screenSize * 0.5f));
        // upper left corner
